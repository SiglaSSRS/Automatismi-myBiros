...
TIPI_DOC = ["CAI", "PAT", "PAS", "TS", "BP", "OBIS", "CP", "PE", "MC", "CS", "CUD", "PS"] # mappatura documenti su CRM (provvisoria)
...
def analizzaDocumento(tipo, b64, estensione):
    ...
    elif    tipo == "PAT":  return myBiros.estraiDatiDocumento_b64(b64, estensione)
    elif    tipo == "PAS":  return myBiros.estraiDatiDocumento_b64(b64, estensione)
    elif    tipo == "TS" :  return myBiros.estraiDatiDocumento_b64(b64, estensione)
    elif    tipo == "PS" :  return myBiros.estraiDatiDocumento_b64(b64, estensione)
    ...
    elif    tipo == "CP":   return myBiros.estraiDatiCedolinoPensione_b64(b64, estensione)
    elif    tipo == "PE":   return myBiros.estraiDatiPrivacyEstesa_b64(b64, estensione)

    elif    tipo == "MC":   return myBiros.estraiDatiMeritoCreditizio_b64(b64, estensione)
    elif    tipo == "CS":   return myBiros.estraiDatiCertificatoStipendio_b64(b64, estensione)
    elif    tipo == "CUD":  return myBiros.estraiDatiCUD_b64(b64, estensione)
...
def aggiornaCRM(id, ret):
    ...
    if obis_netto_pensione:
        ...
        add_campi("ai", campi, "reddito_netto_mensile_c",   "obis_netto_pensione",   mappa_variabili, conf_map,  isDate=False)
    ...
    if categoria_pensione:
        ...
        #Nome	                        Campo	first_name                      - gia inserito in crm
        #Cognome	                    Campo	last_name                       - gia inserito in crm
        #Netto	                        Campo	reddito_netto_mensile_c         cedolino_pensione_lorda
        #Categoria Pensione	            Campo	category_code_c                 categoria_pensione
        #Lordo		
        ...
        add_campi("ai", campi, "codice_fiscale_c",          "codice_fiscale",               mappa_variabili, conf_map,isDate=False)
        add_campi("ai", campi, "reddito_netto_mensile_c",   "cedolino_pensione_lorda",      mappa_variabili, conf_map,isDate=False)
        add_campi("ai", campi, "category_code_c",           "categoria_pensione",           mappa_variabili, conf_map,isDate=False)        
    ...
    if tipo_cud:
        ...
        print("DEBUG - CAMPI MAPPATI")
        print(mappa_variabili)
